        ...
        try {
            ...
            if (file.is_open()) {
                ...
                if (!m_settings.Accept(fromJsonVisitor)) {
                    m_error = anar::common::service::ErrorManager::GenerateError(1, anar::common::constant::ErrorLevel::ANAR_HIGH_ERROR, "Error on read settings file");
                    m_error.SubErrors.emplace_back(*fromJsonVisitor.Error());
                }
            } else {
                m_error = anar::common::service::ErrorManager::GenerateError(1, anar::common::constant::ErrorLevel::ANAR_HIGH_ERROR, "Error on open settings file");
            }
        ...
        try {
            ...
            if (file.is_open()) {
                ...
                if (m_settings.Accept(toJsonVisitor)) {
                    ...
                    m_error = anar::common::service::ErrorManager::GenerateError(1, anar::common::constant::ErrorLevel::ANAR_HIGH_ERROR, "Error on write settings file");
            ...
            m_error = anar::common::service::ErrorManager::GenerateError(1, anar::common::constant::ErrorLevel::ANAR_HIGH_ERROR, "Error on write settings file: " + std::string(exception.what()));
        }
        return anar::common::service::ErrorManager::HaveNoError(m_error);
    }
}  // namespace anar::parspark::service
