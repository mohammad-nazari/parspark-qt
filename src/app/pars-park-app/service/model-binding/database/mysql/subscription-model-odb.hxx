...
#include "model/subscription-model.hpp"
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::anar::model::SubscriptionModel >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::anar::model::SubscriptionModel >
  {
    public:
    typedef ::anar::model::SubscriptionModel object_type;
    typedef ::std::shared_ptr< ::anar::model::SubscriptionModel > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >:
  ...
  template <typename A>
  const typename pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Id_type_
  pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Id (A::table_name, "`id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Card_type_
  pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Card (A::table_name, "`card_id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::ValidateTimesJson_type_
  pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  ValidateTimesJson (A::table_name, "`validate_times_json`", 0);

  template <typename A>
  const typename pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::subscription_cost_type_
  pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  subscription_cost (A::table_name, "`subscription_cost`", 0);

  template <typename A>
  const typename pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Car_type_
  pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Car (A::table_name, "`car_id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Driver_type_
  pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Driver (A::table_name, "`driver_id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Organization_type_
  pointer_query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Organization (A::table_name, "`organization_id`", 0);

  template <>
  class access::object_traits_impl< ::anar::model::SubscriptionModel, id_mysql >:
    public access::object_traits< ::anar::model::SubscriptionModel >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::anar::model::SubscriptionModel, id_common >:
    public access::object_traits_impl< ::anar::model::SubscriptionModel, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::anar::model::SubscriptionModel, id_mysql >
  {
    // Card
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::anar::model::SubscriptionModel, id_mysql, A >:
    query_columns_base< ::anar::model::SubscriptionModel, id_mysql >,
  ...
  template <typename A>
  const typename query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Id_type_
  query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Id (A::table_name, "`id`", 0);

  template <typename A>
  const typename query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Card_type_
  query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Card (A::table_name, "`card_id`", 0);

  template <typename A>
  const typename query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::ValidateTimesJson_type_
  query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  ValidateTimesJson (A::table_name, "`validate_times_json`", 0);

  template <typename A>
  const typename query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::subscription_cost_type_
  query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  subscription_cost (A::table_name, "`subscription_cost`", 0);

  template <typename A>
  const typename query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Car_type_
  query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Car (A::table_name, "`car_id`", 0);

  template <typename A>
  const typename query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Driver_type_
  query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Driver (A::table_name, "`driver_id`", 0);

  template <typename A>
  const typename query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::Organization_type_
  query_columns< ::anar::model::SubscriptionModel, id_mysql, A >::
  Organization (A::table_name, "`organization_id`", 0);
}
