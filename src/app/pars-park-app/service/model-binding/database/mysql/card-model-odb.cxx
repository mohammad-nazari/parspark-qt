...
namespace odb
{
  ...
  struct access::object_traits_impl< ::anar::model::CardModel, id_mysql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::anar::model::CardModel, id_mysql >::id_type
  access::object_traits_impl< ::anar::model::CardModel, id_mysql >::
  ...
  bool access::object_traits_impl< ::anar::model::CardModel, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::anar::model::CardModel, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::anar::model::CardModel, id_mysql >::persist_statement[] =
  "INSERT INTO `card` "
  "(`creating_user_id`, "
  "`updating_user_id`, "
  "`created_time`, "
  ...
  const char access::object_traits_impl< ::anar::model::CardModel, id_mysql >::find_statement[] =
  "SELECT "
  ...
  const char access::object_traits_impl< ::anar::model::CardModel, id_mysql >::update_statement[] =
  "UPDATE `card` "
  "SET "
  "`creating_user_id`=?, "
  "`updating_user_id`=?, "
  ...
  const char access::object_traits_impl< ::anar::model::CardModel, id_mysql >::erase_statement[] =
  "DELETE FROM `card` "
  "WHERE `id`=?";

  const char access::object_traits_impl< ::anar::model::CardModel, id_mysql >::query_statement[] =
  "SELECT\n"
  "`card`.`creating_user_id`,\n"
  "`card`.`updating_user_id`,\n"
  "`card`.`created_time`,\n"
  ...
  const char access::object_traits_impl< ::anar::model::CardModel, id_mysql >::erase_query_statement[] =
  "DELETE FROM `card`";

  const char access::object_traits_impl< ::anar::model::CardModel, id_mysql >::table_name[] =
  "`card`";
  ...
  access::object_traits_impl< ::anar::model::CardModel, id_mysql >::pointer_type
  access::object_traits_impl< ::anar::model::CardModel, id_mysql >::
  ...
  result< access::object_traits_impl< ::anar::model::CardModel, id_mysql >::object_type >
  access::object_traits_impl< ::anar::model::CardModel, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::anar::model::CardModel, id_mysql >::
