       ...
       public:
        ...
        bool Select(const odb::query<TableTemp>& query, std::vector<TableTemp>& resultList) {
            ...
            try {
                ...
                transaction.commit();
            } catch (odb::database_exception& exception) {
                ...
                m_error = service::ErrorManager::GenerateError(1, constant::ErrorLevel::ANAR_FATAL, std::string("Database error (Internal): ") + exception.what());
            } catch (...) {
                m_error = service::ErrorManager::GenerateError(1, constant::ErrorLevel::ANAR_FATAL, std::string("Database error: Unknown error"));
            }
