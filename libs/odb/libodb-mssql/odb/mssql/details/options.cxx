  ...
  namespace mssql
  {
    namespace details
    {
      ...
      print_usage (::std::ostream& os)
      {
        ...
        os << "--password|-P <str>   SQL Server database password. Omit this option if the" << ::std::endl
           << "                      user password is blank or Windows authentication is used." << ::std::endl;

        os << "--database|-d <name>  SQL Server database name. If not specified, then the" << ::std::endl
           << "                      default database for this user is used." << ::std::endl;

        os << "--server|-S <addr>    SQL Server instance address in the" << ::std::endl
           << "                      '[protocol:]host[\\instance][,port]' format, where" << ::std::endl
           << "                      'protocol' can be 'tcp' (TCP/IP), 'lpc' (shared memory)," << ::std::endl
           << "                      or 'np' (named pipe). If not specifid, then 'localhost'" << ::std::endl
           << "                      is used." << ::std::endl;

        os << "--driver <name>       SQL Server Native Client ODBC driver name. If not" << ::std::endl
